    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function activeSlidesNavigation(slidesNav, slideIndex){
            slidesNav.each(function() {
                $(this).find(ACTIVE_SEL).removeClass(ACTIVE);
                $(this).find('li').eq(slideIndex).find('a').addClass(ACTIVE);
            });
        }
        ...
        */
        function addSlidesNavigation(section, numSlides){
            section.find('.viewAll').before('<div class="' + SLIDES_NAV + '"><ul></ul></div>');
